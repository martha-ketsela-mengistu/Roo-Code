...
const INTENT_ID_PARAMETER_DESCRIPTION = `The active intent id selected via select_active_intent (for example INT-001 or REQ-001).`

const MUTATION_CLASS_PARAMETER_DESCRIPTION = `Semantic mutation class for this write. Use AST_REFACTOR for intent-preserving changes, or INTENT_EVOLUTION for feature/requirement evolution.`
